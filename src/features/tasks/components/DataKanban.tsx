 ...
 const newTasks: TaskState = {
  ...
  const onDragEnd = useCallback((result: DropResult) => {
   ...
   setTasks((prevTasks) => {
    ...
    // if there's no moved task (shouldn't happen , but just in case) return the prevTask
    if(!movedTask) {
        console.log('No task found at the source index')
        return prevTasks;
    }

    // create a new tasl object with potentially updated status
   ...
   // If the task moved between column, update positions in the source colummn
